...
function Footer() {
  return (
    <div>
        <div className='main h-screen w-full bg-slate-900 p-20 flex gap-5'>
        <div className='w-1/2 h-full flex flex-col items-center justify-between'>
            <div className='headings font-["Founders_Grotesk_Font_Family_(Fontmirror)/Test Founders Grotesk Bold 700.otf"]'>
                <h1 className='text-6xl text-white font-bold tracking-tight'>EYE-</h1>
                <h1 className='text-6xl text-white font-bold tracking-tight'>Opening</h1>
                <svg className=" mt-56 text-white"width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2'>
            <div className='headings2 '>
                <h1 className='uppercase text-4xl text-white tracking-tighter font-semibold'>Presentations</h1>
                <div className='links mt-10'>
                    {["Facebook","Twitter","Instagram"].map((item,index)=>(
                        <div key={index}>
                            <a className='text-white text-xl underline font-light justify-between' href='#'>{item}</a>
                        </div>
                    ))}
                </div>
            </div>
